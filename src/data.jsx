const reviews = [
  {
    ...
    image: "https://i.ibb.co/RBKzsHr/121499348-1.jpg", 
    text: "My name is Yash Mishra, a Front-End Developer skilled in HTML, CSS, Tailwind CSS, JavaScript, React.js, and Firebase. Pursuing a BCA degree from GH Raisoni, Nagpur. Future goal: Improve Front-End skills with TypeScript, Next.js, and contribute to open-source projects."
  ...
  },
  {
    ...
    name: "Tushar Utane,",
    job: "Front-End Developer",
    image: "https://i.ibb.co/NTCc33j/89387408.jpg" , 
    text: "My name is Tushar Utane, a Front-End Developer proficient in HTML, CSS, Tailwind CSS, JavaScript, React.js, TypeScript, and Firebase. Currently pursuing a BCA degree from GH Raisoni, Nagpur. My future goal is to enhance my Front-End skills with Next.js and actively contribute to open-source projects."
  },
  {
    id: 3,
    name: "Pranay Gupta",
